                                            ...
                                            @if (!empty($content['link']))
                                                <tr>
                                                    <td style="padding: 0; text-align: center;">
                                                        <a href="{{ $content['link'] }}"
                                                            style="display: inline-block; text-align: center; margin-top: 5px; background: #077EFF; color: #fff; text-decoration: none; padding: 10px 30px; border-radius: 10px; font-weight: 500;">Reset Password</a>
                                                    </td>
                                                </tr>
                                            @endif
                                            <tr>
