...
@if (request()->segment(3) == 'edit' || request()->segment(3) == 'add')
    {!!breadcrumb('Add/Update Preferred Pharmacy')!!}
                  ...
                  <div class="col-lg-12 d-flex align-items-stretch">
                    <div class="card w-100 border position-relative overflow-hidden">
                      <div class="card-body p-4">
                        <h4 class="card-title">Preferred Pharmacy Block</h4>
                          <div class="row">
                              <div class="col-6">
                                <div class="mb-3">
...
@else
{!!breadcrumb('Preferred Pharmacy',url('admin/preferred_pharmacy/add/'))!!}
<div class="card">
  <div class="card-body">
      <div class="row">
                    ...
                    <td>
                        <div class="dropdown dropstart">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <li>
                                <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/preferred_pharmacy/edit/' . $row->id) }}">
                                  <i class="fs-4 ti ti-edit"></i>Edit
                                </a>
                              </li>
                              <li>
                                <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/preferred_pharmacy/delete/' . $row->id) }}"  onclick="return confirm('Are you sure?');">
