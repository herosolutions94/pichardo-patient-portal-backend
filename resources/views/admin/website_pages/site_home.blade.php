        ...
        <div class="row">
            <div class="col">
                <div class="card w-100 border position-relative overflow-hidden">
                    <div class="card-body p-4">
                      <div class="text-center">
                       <div class="file_choose_icon">
                          <img src="{{ get_site_image_src('images', $sitecontent['image8']) }}" alt="matdash-img" class="img-fluid " >
                       </div>
                        <p class="mb-0">Allowed JPG, GIF or PNG. Max size of 800K</p>
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="mb-4">
                            <label class="form-label" for="section4_link_text_{{ $i }}">Link Text {{ $i }}</label>
                            <input class="form-control" id="section4_link_text_{{ $i }}" type="text"
                                name="section4_link_text_{{ $i }}" placeholder=""
                                value="{{ !empty($sitecontent['section4_link_text_' . $i]) ? $sitecontent['section4_link_text_' . $i] : '' }}">
                        </div>
                    </div>
                    <div class="col">
                        <div class="mb-4">
                            <label class="form-label" for="section4_link_url_{{ $i }}">Link URL {{ $i }}</label>
                            <select name="section4_link_url_{{ $i }}" class="form-control" required>
                                @foreach ($all_pages as $key => $page)
                                    <option value="{{ $key }}"
                                        {{ !empty($sitecontent['section4_link_url_' . $i]) && $sitecontent['section4_link_url_' . $i] == $key ? 'selected' : '' }}>
                                        {{ $page }}</option>
                                @endforeach
                            </select>
                        </div>
            ...
            <div class="col">
                <div class="card w-100 border position-relative overflow-hidden">
                    <div class="card-body p-4">
                      <div class="text-center">
                       <div class="file_choose_icon">
                          <img src="{{ get_site_image_src('images', $sitecontent['image12']) }}" alt="matdash-img" class="img-fluid " >
                       </div>
                        <p class="mb-0">Allowed JPG, GIF or PNG. Max size of 800K</p>
                ...
                <div class="row">
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <textarea id="section6_text" name="section6_text" rows="6" class=" editor">{{ !empty($sitecontent['section6_text']) ? $sitecontent['section6_text'] : "" }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card w-100 border position-relative overflow-hidden">
                    <div class="card-body p-4">
                      <div class="text-center">
                       <div class="file_choose_icon">
                          <img src="{{ get_site_image_src('images', $sitecontent['image13']) }}" alt="matdash-img" class="img-fluid " >
                       </div>
                        <p class="mb-0">Allowed JPG, GIF or PNG. Max size of 800K</p>
                        <input class="form-control uploadFile" name="image13" type="file"
                            data-bs-original-title="" title="">
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <textarea id="section7_text" name="section7_text" rows="7" class=" editor">{{ !empty($sitecontent['section7_text']) ? $sitecontent['section7_text'] : "" }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col">
                        <div class="mb-4">
                            <label class="form-label" for="section7_link_text_{{ $i }}">Link Text {{ $i }}</label>
                            <input class="form-control" id="section7_link_text_{{ $i }}" type="text"
                                name="section7_link_text_{{ $i }}" placeholder=""
                                value="{{ !empty($sitecontent['section7_link_text_' . $i]) ? $sitecontent['section7_link_text_' . $i] : '' }}">
                        </div>
                    </div>
                    <div class="col">
                        <div class="mb-7">
                            <label class="form-label" for="section7_link_url_{{ $i }}">Link URL {{ $i }}</label>
                            <select name="section7_link_url_{{ $i }}" class="form-control" required>
                                @foreach ($all_pages as $key => $page)
                                    <option value="{{ $key }}"
                                        {{ !empty($sitecontent['section7_link_url_' . $i]) && $sitecontent['section7_link_url_' . $i] == $key ? 'selected' : '' }}>
                                        {{ $page }}</option>
                                @endforeach
                            </select>
                        </div>
