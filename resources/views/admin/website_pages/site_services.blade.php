...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="mb-4">
                    <label class="form-label" for="section2_link_text_{{ $i }}">Link Text {{ $i }}</label>
                    <input class="form-control" id="section2_link_text_{{ $i }}" type="text"
                        name="section2_link_text_{{ $i }}" placeholder=""
                        value="{{ !empty($sitecontent['section2_link_text_' . $i]) ? $sitecontent['section2_link_text_' . $i] : '' }}">
                </div>
            </div>
            <div class="col">
                <div class="mb-2">
                    <label class="form-label" for="section2_link_url_{{ $i }}">Link URL {{ $i }}</label>
                    <select name="section2_link_url_{{ $i }}" class="form-control" required>
                        @foreach ($all_pages as $key => $page)
                            <option value="{{ $key }}"
                                {{ !empty($sitecontent['section2_link_url_' . $i]) && $sitecontent['section2_link_url_' . $i] == $key ? 'selected' : '' }}>
                                {{ $page }}</option>
                        @endforeach
                    </select>
                </div>
